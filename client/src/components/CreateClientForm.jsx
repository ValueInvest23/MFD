...
const CreateClientForm = () => {
  ...
  const inputClass =
    "peer block w-full appearance-none rounded-3xl border border-zinc-700 bg-zinc-900 px-4 pt-6 pb-2 text-white placeholder-transparent focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200";

  const selectClass =
    "peer block w-full appearance-none rounded-3xl border border-zinc-700 bg-zinc-900 px-4 pt-6 pb-2 text-white focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200 pr-10";

  const labelClass =
    "pointer-events-none absolute left-4 top-2 text-sm text-blue-400 transition-all duration-200 transform scale-90 origin-top-left peer-placeholder-shown:scale-100 peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-placeholder-shown:text-zinc-500 peer-focus:top-2 peer-focus:scale-90 peer-focus:text-sm peer-focus:text-blue-400";
